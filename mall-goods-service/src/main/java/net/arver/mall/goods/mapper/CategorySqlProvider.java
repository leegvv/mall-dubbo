...
import net.arver.mall.goods.model.CategoryExample.Criteria;
import net.arver.mall.goods.model.CategoryExample.Criterion;
...
public class CategorySqlProvider {
    ...
    public String insertSelective(Category record) {
        ...
        if (record.getIsMenu() != null) {
            sql.VALUES("is_menu", "#{isMenu,jdbcType=CHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getIsMenu() != null) {
            sql.SET("is_menu = #{record.isMenu,jdbcType=CHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Category record) {
        ...
        if (record.getGoodsNum() != null) {
            sql.SET("goods_num = #{goodsNum,jdbcType=INTEGER}");
        }
        ...
        if (record.getIsMenu() != null) {
            sql.SET("is_menu = #{isMenu,jdbcType=CHAR}");
        }
