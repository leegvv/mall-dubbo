...
import net.arver.mall.goods.model.SpecExample.Criteria;
import net.arver.mall.goods.model.SpecExample.Criterion;
...
public class SpecSqlProvider {
     ...
     */
    public String countByExample(SpecExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("tb_spec");
     ...
     * @mbg.generated Wed Jul 08 23:31:15 CST 2020
     */
    public String deleteByExample(SpecExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("tb_spec");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Wed Jul 08 23:31:15 CST 2020
     */
    public String selectByExample(SpecExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Spec record = (Spec) parameter.get("record");
        SpecExample example = (SpecExample) parameter.get("example");
     ...
     * @mbg.generated Wed Jul 08 23:31:15 CST 2020
     */
    protected void applyWhere(SQL sql, SpecExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
